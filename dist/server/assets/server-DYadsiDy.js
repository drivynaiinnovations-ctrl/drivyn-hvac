...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bt9EaTq-.js");
...
const manifest = {
  "5f80d72f2aace967a2b593bc23f88ed25515b0a3b3acf2bdf0bc61f60d2c6c93": {
    functionName: "classifyIssue_createServerFn_handler",
    importer: () => import("./classify-BKgLURAT.js").then((n2) => n2.c)
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B_P3zg7Z.js").then((n2) => n2.r),
    import("./start-DvTehqX5.js"),
...
export {
  resolveManifestCssLink as $,
  getServerFnById as A,
  hasKeys as B,
  interpolatePath as C,
