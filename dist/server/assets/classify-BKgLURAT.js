import { T as TSS_SERVER_FUNCTION, j as createServerFn } from "./server-DYadsiDy.js";
...
async function _EnvironmentWorker_handleItem2(work, environmentKey, externalSignal) {
  ...
  const agentToolset = await import("./node-MfJJaGID.js");
...
Anthropic.Beta = Beta;
const classifyIssue_createServerFn_handler = createServerRpc({
  id: "5f80d72f2aace967a2b593bc23f88ed25515b0a3b3acf2bdf0bc61f60d2c6c93",
  name: "classifyIssue",
  filename: "src/lib/classify.ts"
}, (opts) => classifyIssue.__executeServer(opts));
...
}).handler(classifyIssue_createServerFn_handler, async ({
  data
}) => {
...
Issue: ${data.issue}`
  ...
  return {
    urgent: text.includes("EMERGENCY")
  };
});
const classify = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  classifyIssue_createServerFn_handler
