import { W as reactExports, x as getAugmentedNamespace, y as getDefaultExportFromCjs, M as jsxRuntimeExports, T as TSS_SERVER_FUNCTION, A as getServerFnById, j as createServerFn } from "./server-DYadsiDy.js";
import { h as heroAcImg } from "./router-B_P3zg7Z.js";
...
const AirVent = createLucideIcon("air-vent", __iconNode$p);
const __iconNode$o = [
...
const heroHeatImg = "/assets/hero-heat-BZX6lF5c.jpg";
const heroMaintenanceImg = "/assets/hero-maintenance-30iu5Fia.jpg";
var vapi = {};
function e(e2, t2) {
  if (null == e2) return {};
...
(() => {
  ...
  if (!e2 || !e2.now) return;
  e2.now();
  e2.timing && e2.timing.navigationStart;
})(), (function(e2) {
...
var Os = (function() {
  function e2() {
    var n2, r2, i2, o2;
    return t(this, e2), r2 = this, i2 = a(i2 = e2), (n2 = s(r2, Ts() ? Reflect.construct(i2, [], a(r2).constructor) : i2.apply(r2, o2)))._wrappedListeners = {}, n2._messageCallbacks = {}, n2;
  }
...
var js = (function() {
  function e2() {
    var n2, r2, i2, o2;
    return t(this, e2), r2 = this, i2 = a(i2 = e2), n2 = s(r2, As() ? Reflect.construct(i2, [], a(r2).constructor) : i2.apply(r2, o2)), global.callMachineToDailyJsEmitter = global.callMachineToDailyJsEmitter || new y.EventEmitter(), global.dailyJsToCallMachineEmitter = global.dailyJsToCallMachineEmitter || new y.EventEmitter(), n2._wrappedListeners = {}, n2._messageCallbacks = {}, n2;
  }
  return l(e2, Ms), o(e2, [{ key: "addListenerForMessagesFromCallMachine", value: function(e3, t2, n2) {
...
var oa = /* @__PURE__ */ new Map(), sa = null;
function aa(e2, t2) {
  var n2 = "undefined" != typeof Symbol && e2[Symbol.iterator] || e2["@@iterator"];
  if (!n2) {
    if (Array.isArray(e2) || (n2 = (function(e3, t3) {
...
var la = /* @__PURE__ */ new Map(), ua = null;
function da(e2) {
  ha() ? (function(e3) {
...
var ya = Object.freeze({ VIDEO: "video", AUDIO: "audio", SCREEN_VIDEO: "screenVideo", SCREEN_AUDIO: "screenAudio", CUSTOM_VIDEO: "customVideo", CUSTOM_AUDIO: "customAudio" }), ba = Object.freeze({ PARTICIPANTS: "participants", STREAMING: "streaming", TRANSCRIPTION: "transcription" }), _a = Object.values(ya), wa = ["v", "a", "sv", "sa", "cv", "ca"];
...
var Sa = [ya.VIDEO, ya.AUDIO, ya.SCREEN_VIDEO, ya.SCREEN_AUDIO], ka = Object.values(ba), Ma = ["p", "s", "t"];
...
}, help: 'layout may only be set to "custom-v1"', queryString: "layout" }, emb: { queryString: "emb" }, embHref: { queryString: "embHref" }, dailyJsVersion: { queryString: "dailyJsVersion" }, proxy: { queryString: "proxy" }, strictMode: true, allowMultipleCallInstances: true }, Wa = { styles: { validate: function(e2) {
...
var Ha = (function() {
  function r2(e2) {
    ...
    if (t(this, r2), o2 = this, c3 = a(c3 = r2), u(i3 = s(o2, ja() ? Reflect.construct(c3, [], a(o2).constructor) : c3.apply(o2, l2)), "startListeningForDeviceChanges", (function() {
  ...
  return l(r2, b), o(r2, [{ key: "destroy", value: (ee2 = p((function* () {
    ...
    return e2 ? e2 instanceof MediaStreamTrack ? !!va(e2) || (console.error("Video track is not playable. This test needs a live video track."), false) : (console.error("Video track needs to be of type `MediaStreamTrack`."), false) : (console.error("Missing video track. You must provide a video track in order to run this test."), false);
...
const dailyEsm = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const require$$0 = /* @__PURE__ */ getAugmentedNamespace(dailyEsm);
var client = {};
var api = {};
var hasRequiredApi;
function requireApi() {
  ...
  api.Api = api.HttpClient = api.ContentType = void 0;
  var ContentType;
...
var dailyGuards = {};
var hasRequiredDailyGuards;
function requireDailyGuards() {
  if (hasRequiredDailyGuards) return dailyGuards;
  hasRequiredDailyGuards = 1;
  Object.defineProperty(dailyGuards, "__esModule", { value: true });
  dailyGuards.createSafeDailyConfig = createSafeDailyConfig;
  dailyGuards.safeSetLocalAudio = safeSetLocalAudio;
  dailyGuards.safeSetInputDevicesAsync = safeSetInputDevicesAsync;
  dailyGuards.createSafeDailyFactoryOptions = createSafeDailyFactoryOptions;
...
var hasRequiredVapi;
function requireVapi() {
  if (hasRequiredVapi) return vapi;
  hasRequiredVapi = 1;
  var __importDefault = vapi && vapi.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { "default": mod };
  };
  Object.defineProperty(vapi, "__esModule", { value: true });
  const daily_js_1 = __importDefault(require$$0);
  const events_1 = __importDefault(require$$1);
  const client_1 = requireClient();
  const daily_guards_1 = requireDailyGuards();
  ...
  class Vapi2 extends VapiEventEmitter {
    started = false;
    call = null;
...
var vapiExports = requireVapi();
const Vapi = /* @__PURE__ */ getDefaultExportFromCjs(vapiExports);
const VAPI_API_KEY = "db2e2fe6-173a-4668-8b6f-f2d03cbd4abc";
const VAPI_ASSISTANT_ID = "99637b3f-ed53-4a2a-a88c-496521bb69a0";
let _vapi = null;
function getVapi() {
...
function startVapi(assistantId = VAPI_ASSISTANT_ID) {
  getVapi()?.start(assistantId);
}
function stopVapi() {
  _vapi?.stop();
}
function onVapiEvent(event, handler) {
  getVapi()?.on(event, handler);
}
function offVapiEvent(event, handler) {
...
function VoiceWidget() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3", children: [
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-72 rounded-2xl bg-white shadow-luxe border border-border p-4 animate-in fade-in slide-in-from-bottom-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-charcoal font-semibold text-sm", children: "AI Assistant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: isActive ? "Call in progress" : "Available 24/7" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(false), className: "text-muted-foreground hover:text-charcoal", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X$1, { className: "size-4" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-charcoal/80 mb-3", children: '"Hi, this is ABC HVAC. How can I help you today?"' }),
      isActive ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneOff, { className: "size-4" }),
            " End Call"
          ]
        }
        ...
        "button",
        {
          ...
          children: callStatus === "connecting" ? "Connecting..." : "Start Voice Conversation"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneOff, { className: "size-7" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Headset, { className: "size-7" })
      }
    ),
    !open && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-xs text-charcoal bg-white/95 backdrop-blur px-3 py-1.5 rounded-full shadow border border-border", children: isActive ? "Call in progress..." : "Speak With A Live Agent Now — 24/7" })
  ] });
}
function DemoTab() {
  const [open, setOpen] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (!open) return;
    const onKey = (e2) => e2.key === "Escape" && setOpen(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: "See How Our AI Works — Try Demo"
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-charcoal/60 backdrop-blur-sm flex items-center justify-center p-4", onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: (e2) => e2.stopPropagation(), className: "bg-white rounded-2xl max-w-lg w-full p-6 shadow-luxe", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "size-5 text-turquoise" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-charcoal", children: "AI Assistant Demo" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X$1, { className: "size-5 text-muted-foreground" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble, { who: "AI", children: "Hi, this is ABC HVAC. How can I help you today?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble, { who: "You", children: "My heat just stopped working and it's freezing." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble, { who: "AI", children: "I'm sorry to hear that. I'm marking this as an emergency. Can I confirm your address and dispatch a technician now?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble, { who: "You", children: "Yes — 123 Elm St, Bethesda." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble, { who: "AI", children: "Done. Technician Marcus will arrive within 45 minutes. You'll get an SMS confirmation in a moment." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function Bubble({ who, children }) {
  const isAI = who === "AI";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isAI ? "justify-start" : "justify-end"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[80%] px-4 py-2.5 rounded-2xl ${isAI ? "bg-secondary text-charcoal rounded-bl-sm" : "bg-turquoise text-white rounded-br-sm"}`, children }) });
}
const SCRIPT = [
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      for (let i2 = 0; i2 < SCRIPT.length; i2++) {
        ...
        const line = SCRIPT[i2];
        setLines((prev) => [...prev, { ...line, text: "", done: false }]);
        for (let c2 = 1; c2 <= line.text.length; c2++) {
          if (cancelRef.current) return;
          await new Promise((r2) => setTimeout(r2, TYPE_SPEED));
          setLines((prev) => {
            const next = [...prev];
            next[next.length - 1] = { ...next[next.length - 1], text: line.text.slice(0, c2) };
            return next;
          });
        ...
        await new Promise((r2) => setTimeout(r2, PAUSE_BETWEEN));
      }
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pt-6 pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-2.5 rounded-full bg-turquoise animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold text-charcoal leading-tight", children: "ABC HVAC — AI Assistant Demo" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Live conversation simulation" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: lines.map((l2, i2) => {
                  const isAI = l2.who === "AI";
                  const showCaret = !l2.done;
                  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isAI ? "justify-start" : "justify-end"} animate-in fade-in slide-in-from-bottom-2`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[82%] px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${isAI ? "bg-white text-charcoal rounded-bl-sm border border-border" : "bg-turquoise text-white rounded-br-sm"}`, children: [
                    l2.text,
                    showCaret && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-block w-[2px] h-4 align-middle ml-0.5 ${isAI ? "bg-charcoal" : "bg-white"} animate-pulse` })
                  ] }) }, i2);
                })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 py-5 border-t border-border transition-opacity duration-500 ${finished ? "opacity-100" : "opacity-40 pointer-events-none"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs font-semibold tracking-[0.18em] uppercase text-turquoise mb-3", children: "This is a demo — experience the real thing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    " Talk to Alex Now — Try the Live AI"
                  ]
                }
              )
            ] })
...
const classifyIssue = createServerFn({
  method: "POST"
}).inputValidator((data) => {
  const {
    issue
...
}).handler(createSsrRpc("5f80d72f2aace967a2b593bc23f88ed25515b0a3b3acf2bdf0bc61f60d2c6c93"));
const ALEX_DELAY = 900;
function AlexChat({ open, onClose }) {
  ...
  function addUser(text) {
    setMessages((m2) => [...m2, { role: "user", text }]);
  }
  function alexSay(text, then) {
    setTyping(true);
    setTimeout(() => {
      setTyping(false);
      setMessages((m2) => [...m2, { role: "alex", text }]);
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-border flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-full bg-turquoise flex items-center justify-center text-white font-bold text-sm", children: "A" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-charcoal text-sm leading-tight", children: "Alex · ABC HVAC" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-turquoise flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-turquoise animate-pulse inline-block" }),
                    " Online now"
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, "aria-label": "Close", className: "size-8 rounded-full hover:bg-secondary flex items-center justify-center text-charcoal/60 hover:text-charcoal transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X$1, { className: "size-4" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scrollRef, className: "px-4 py-4 space-y-3 max-h-72 overflow-y-auto bg-secondary/20", children: [
              messages.map((m2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${m2.role === "user" ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[80%] px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${m2.role === "user" ? "bg-turquoise text-white rounded-br-sm" : "bg-white text-charcoal border border-border rounded-bl-sm shadow-sm"}`, children: m2.text }) }, i2)),
              typing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-border rounded-2xl rounded-bl-sm px-4 py-3 shadow-sm flex gap-1 items-center", children: [0, 1, 2].map((i2) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-charcoal/30 animate-bounce", style: { animationDelay: `${i2 * 150}ms` } }, i2)) }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "px-4 py-3 border-t border-border flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ref: inputRef,
                  ...
                  placeholder: step === "name" ? "Your full name…" : step === "phone" ? "Phone number…" : step === "issue" ? "Describe the issue…" : "",
...
const CALC_SERVICES = [{
  ...
  label: "AC Repair",
  icon: Wind,
  ranges: [[150, 300], [300, 600], [600, 1500]]
}, {
  key: "ac_install",
  label: "AC Installation",
  icon: AirVent,
  ranges: [[3500, 5500], [5500, 9e3], [9e3, 15e3]]
}, {
  key: "furnace_repair",
  label: "Furnace Repair",
  icon: Flame,
  ranges: [[150, 350], [350, 700], [700, 2e3]]
}, {
  key: "furnace_install",
  label: "Furnace Install",
  icon: Flame,
  ranges: [[2500, 4500], [4500, 7500], [7500, 12e3]]
}, {
  key: "heat_pump",
  label: "Heat Pump",
  icon: Thermometer,
  ranges: [[3e3, 5e3], [5e3, 8500], [8500, 14e3]]
}, {
  key: "duct_cleaning",
  label: "Duct Cleaning",
  icon: Funnel,
  ranges: [[300, 500], [500, 800], [800, 1500]]
}, {
  key: "thermostat",
  label: "Thermostat",
  icon: Gauge,
  ranges: [[150, 250], [250, 450], [450, 700]]
}, {
  key: "air_quality",
  label: "Air Quality",
  icon: Wind,
  ranges: [[200, 400], [400, 700], [700, 1200]]
}];
const URGENCY_OPTIONS = [{
  value: "standard",
  label: "Standard (8am – 6pm)",
  surcharge: 0
}, {
  value: "evening",
  label: "Evening / Night (+$150)",
  surcharge: 150
}, {
  value: "weekend",
  label: "Weekend / Holiday (+$200)",
  surcharge: 200
}, {
  value: "emergency",
  label: "Same-Day Emergency (+$350)",
  surcharge: 350
}];
function PriceCalculator({
  onBook
}) {
  const [serviceKey, setServiceKey] = reactExports.useState("ac_repair");
  const [complexity, setComplexity] = reactExports.useState(1);
  const [urgency, setUrgency] = reactExports.useState("standard");
  const service = CALC_SERVICES.find((s2) => s2.key === serviceKey);
  const [low, high] = service.ranges[complexity];
  const surcharge = URGENCY_OPTIONS.find((u2) => u2.value === urgency)?.surcharge ?? 0;
  const estLow = low + surcharge;
  const estHigh = high + surcharge;
  const fmt = (n2) => "$" + n2.toLocaleString();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5 pb-4 border-b border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-xl bg-turquoise/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "size-5 text-turquoise" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-charcoal text-sm", children: "Instant Project Estimate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Get a rough idea of your HVAC costs" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-3", children: "Select Service Type" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2 mb-5", children: CALC_SERVICES.slice(0, 4).map((s2) => {
      const Icon2 = s2.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setServiceKey(s2.key), className: `flex items-center gap-2 px-3 py-2.5 rounded-xl border text-sm font-medium transition ${serviceKey === s2.key ? "border-turquoise bg-turquoise/10 text-turquoise" : "border-gray-200 text-charcoal hover:border-turquoise/50 hover:bg-turquoise/5"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "size-4 shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-left leading-tight", children: s2.label })
      ] }, s2.key);
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1.5 mb-5", children: CALC_SERVICES.slice(4).map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setServiceKey(s2.key), className: `px-2 py-1.5 rounded-lg border text-xs font-medium transition text-center leading-tight ${serviceKey === s2.key ? "border-turquoise bg-turquoise/10 text-turquoise" : "border-gray-200 text-charcoal/70 hover:border-turquoise/50"}`, children: s2.label }, s2.key)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-2", children: "Job Complexity / Size" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "range", min: 0, max: 2, step: 1, value: complexity, onChange: (e2) => setComplexity(Number(e2.target.value)), className: "w-full accent-teal-400 cursor-pointer" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-charcoal/50 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Simple / Small" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Average" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Complex / Large" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-2", children: "Timeline & Urgency" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: urgency, onChange: (e2) => setUrgency(e2.target.value), className: "w-full appearance-none bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-charcoal font-medium focus:outline-none focus:border-turquoise cursor-pointer", children: URGENCY_OPTIONS.map((o2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: o2.value, children: o2.label }, o2.value)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "absolute right-3 top-1/2 -translate-y-1/2 size-4 text-charcoal/40 pointer-events-none" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-turquoise/8 border border-turquoise/20 rounded-xl px-4 py-3 flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-charcoal/60 uppercase tracking-wider", children: "Estimated Cost Range" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl font-bold text-charcoal", children: [
        fmt(estLow),
        " – ",
        fmt(estHigh)
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-charcoal/40 text-center mb-4", children: "Estimates are rough ranges. Final price depends on your specific job. No obligation." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onBook, className: "w-full bg-turquoise hover:opacity-90 text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition shadow-turquoise", children: [
      "Book This Service ",
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-charcoal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onBook: () => setBookingOpen(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, { onBook: () => setBookingOpen(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TrustBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(EstimatorSection, { onBook: () => setBookingOpen(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhoWeServe, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FoundingBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(EmergencyBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FinalCTA, { onBook: () => setBookingOpen(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VoiceWidget, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DemoTab, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlexChat, { open: bookingOpen, onClose: () => setBookingOpen(false) })
  ] });
}
function Header({
  onBook
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-lg bg-turquoise flex items-center justify-center text-white font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AirVent, { className: "size-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-semibold text-charcoal", children: "ABC HVAC" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-8 text-sm font-medium text-charcoal/80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#services", className: "hover:text-turquoise transition", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#estimate", className: "hover:text-turquoise transition", children: "Get Estimate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#who", className: "hover:text-turquoise transition", children: "Who We Serve" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#area", className: "hover:text-turquoise transition", children: "Service Area" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.dispatchEvent(new Event("open-voice-widget")), className: "hover:text-turquoise transition", children: "AI Assistant" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE}`, className: "hidden md:flex items-center gap-2 text-sm font-semibold text-charcoal hover:text-turquoise transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4 text-turquoise" }),
          " ",
          PHONE
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onBook, className: "bg-turquoise text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:opacity-90 transition shadow-turquoise", children: "Book Service" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setMenuOpen((o2) => !o2), "aria-label": "Toggle menu", className: "md:hidden flex items-center justify-center size-9 rounded-lg border border-border text-charcoal hover:bg-secondary transition", children: menuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X$1, { className: "size-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "size-5" }) })
      ] })
    ] }),
    menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-white border-t border-border px-5 py-4 flex flex-col gap-4 text-sm font-medium text-charcoal/80", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#services", onClick: close, className: "hover:text-turquoise transition", children: "Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#estimate", onClick: close, className: "hover:text-turquoise transition", children: "Get Estimate" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#who", onClick: close, className: "hover:text-turquoise transition", children: "Who We Serve" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#area", onClick: close, className: "hover:text-turquoise transition", children: "Service Area" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `tel:${PHONE}`, onClick: close, className: "hover:text-turquoise transition", children: PHONE })
    ] })
  ] });
}
function Hero({
  ...
  reactExports.useEffect(() => {
    const t2 = setInterval(() => setSlide((s2) => (s2 + 1) % total), 5500);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[92vh] flex items-center overflow-hidden", children: [
    HERO_SLIDES.map((s2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s2.img, alt: "", className: `absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ${i2 === slide ? "opacity-100" : "opacity-0"}` }, i2)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-charcoal/95 via-charcoal/80 to-charcoal/30" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-charcoal/80 via-transparent to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-5 lg:px-8 py-24 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-turquoise text-xs font-semibold tracking-[0.2em] uppercase mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-turquoise animate-pulse" }),
        current.badge
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-6xl font-semibold text-white leading-[1.05] mb-6", children: [
        current.line1,
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-turquoise", children: current.line2 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80 leading-relaxed mb-8 max-w-lg", children: current.sub }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onBook, className: "group bg-turquoise text-white font-semibold px-7 py-4 rounded-xl text-base flex items-center justify-center gap-2 hover:opacity-90 shadow-turquoise transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "size-5" }),
          " Book Service Now",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "size-4 group-hover:translate-x-1 transition" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => startVapi(VAPI_ASSISTANT_ID), className: "pulse-ring relative bg-transparent border-2 border-white text-white font-semibold px-7 py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-white hover:text-charcoal transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-5 text-turquoise" }),
          " Speak With Us Now"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 text-sm text-white/70", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-turquoise" }),
          " Arrives in under 45 mins"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-turquoise" }),
          " Upfront pricing"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2.5", children: HERO_SLIDES.map((_2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSlide(i2), className: `rounded-full transition-all duration-300 ${i2 === slide ? "w-8 h-2.5 bg-turquoise" : "w-2.5 h-2.5 bg-white/40 hover:bg-white/70"}` }, i2)) })
  ] });
}
function TrustBar() {
  const items = [{
    ...
    icon: MapPin,
    label: "DMV Area Specialists"
  }, {
    icon: Clock,
    label: "24/7 Emergency Service"
  }, {
    icon: Star,
    label: "4.9★ — 500+ Reviews"
  }, {
    icon: CircleCheck,
    label: "Upfront Flat-Rate Pricing"
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-5 lg:px-8 py-6 grid grid-cols-2 md:grid-cols-5 gap-5", children: items.map((it2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(it2.icon, { className: "size-5 text-turquoise shrink-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-charcoal font-medium", children: it2.label })
  ] }, it2.label)) }) });
}
function EstimatorSection({
  onBook
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "estimate", className: "py-20 bg-secondary/40 scroll-mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-turquoise text-xs font-semibold tracking-[0.2em] uppercase mb-3", children: "Transparent Pricing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl font-semibold text-charcoal mb-5 leading-tight", children: [
        "Know Your Cost ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Before We Arrive."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed mb-6", children: "No surprises, no runaround. Use our instant estimator to get a rough price range for your HVAC project — then book with confidence." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: ["Estimates based on real 2026 DMV contractor pricing", "Select service type, job size, and timing", "Emergency & after-hours rates shown upfront", "Book directly from the calculator"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-charcoal/85", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-turquoise shrink-0 mt-0.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item })
      ] }, item)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 100, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PriceCalculator, { onBook }) })
  ] }) }) });
}
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-3xl mx-auto mb-14", children: [
    kicker && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-turquoise text-xs font-semibold tracking-[0.2em] uppercase mb-3", children: kicker }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: `font-display text-4xl md:text-5xl font-semibold text-charcoal mb-4 ${titleClassName || ""}`, children: title }),
    sub && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: sub })
  ] }) });
}
function WhoWeServe() {
  const cards = [{
    icon: House,
    title: "Residential",
    tag: "Your home. Your comfort. Our priority.",
    ...
    icon: Building2,
    title: "Commercial",
    tag: "Keeping your business comfortable without interruption.",
    ...
    icon: Landmark,
    title: "Government",
    tag: "Meeting the highest standards for public facilities.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "who", className: "py-24 bg-white scroll-mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "Built for Every Customer", title: "One company. Every HVAC need.", sub: "Residential, commercial, and government — one team, one standard of excellence across the entire DMV." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: cards.map((c2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i2 * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group h-full bg-white rounded-2xl border-t-4 border-turquoise p-8 shadow-sm hover:shadow-luxe transition-all hover:-translate-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(c2.icon, { className: "size-10 text-turquoise mb-5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold text-charcoal mb-1", children: c2.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic mb-5", children: c2.tag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: c2.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-sm text-charcoal/85", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-turquoise shrink-0 mt-0.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item })
      ] }, item)) })
    ] }) }, c2.title)) })
...
function Services() {
  const groups = [{
    icon: Wind,
    title: "AC & Cooling",
    items: ["Central AC repair & replacement", "Ductless mini-split install", "Refrigerant recharge & leak fix", "Capacitor & compressor repair", "Emergency same-day AC service", "AC tune-up & seasonal prep"]
  }, {
    icon: Flame,
    title: "Heating & Furnace",
    items: ["Gas & electric furnace repair", "Furnace installation & replacement", "Heat pump install & service", "Ignitor & heat exchanger repair", "Emergency no-heat service", "Carbon monoxide safety checks"]
  }, {
    icon: AirVent,
    title: "Duct Work",
    items: ["Duct cleaning & sanitizing", "Duct sealing & insulation", "Duct repair & replacement", "New ductwork design & install", "Static pressure balancing", "Flex duct replacement"]
  }, {
    icon: Funnel,
    title: "Air Quality",
    items: ["HEPA & media filter upgrades", "UV germicidal light install", "Whole-home humidifiers", "Dehumidifier installation", "IAQ testing & monitoring", "Ventilation improvements"]
  }, {
    icon: Siren,
    title: "Emergency Service",
    items: ["24/7 emergency dispatch", "No-AC response in summer heat", "No-heat response in winter", "Refrigerant leak emergency", "No after-hours surcharge for members", "Government & commercial priority"]
  }, {
    icon: ShieldCheck,
    title: "Maintenance Plans",
    items: ["Spring AC tune-up", "Fall heating tune-up", "Priority scheduling year-round", "Discounts on parts & labor", "Filter replacement reminders", "Energy efficiency reports"]
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-24 bg-secondary/40 scroll-mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "Everything HVAC. All In One Place.", title: "A complete comfort service.", sub: "We handle everything — from a tripped breaker to a full system replacement. No subcontracting, no runaround." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: groups.map((g2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i2 % 2 * 80, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full p-8 rounded-2xl border border-border hover:border-turquoise/50 transition bg-white hover:shadow-luxe", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-12 rounded-xl bg-turquoise/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(g2.icon, { className: "size-6 text-turquoise" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold text-charcoal", children: g2.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: g2.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-charcoal/85", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-turquoise shrink-0 mt-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item })
      ] }, item)) })
    ] }) }, g2.title)) })
  ] }) });
...
function HowItWorks() {
  const steps = [{
    ...
    body: "Use our instant calculator to see a price range for your job. No obligation — just transparency before anyone shows up."
  }, {
    n: "02",
    title: "Book & We Dispatch",
    body: "Book online, by phone, or via AI in seconds. A licensed ABC HVAC technician is dispatched with the right parts to fix it right the first time."
  }, {
    n: "03",
    title: "Problem Solved. Guaranteed.",
    body: "We complete the work, walk you through what was done, and back it with a satisfaction guarantee. Follow-up is automated — no chasing required."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "How It Works", title: "From Hot to Fixed in 3 Steps" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block absolute top-10 left-[16%] right-[16%] h-px bg-gradient-to-r from-turquoise/20 via-turquoise to-turquoise/20" }),
      steps.map((s2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i2 * 150, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-secondary/40 rounded-2xl p-8 border border-border text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-20 mx-auto rounded-full bg-white border-2 border-turquoise flex items-center justify-center font-display text-2xl font-bold text-turquoise mb-5 relative z-10 shadow-sm", children: s2.n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-charcoal mb-3", children: s2.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: s2.body })
      ] }) }, s2.n))
    ] })
  ] }) });
}
function AISection() {
  ...
  const features = [{
    ...
    body: "Answers every call in under 1 second. Handles FAQs, books appointments, and routes emergencies to a live HVAC tech immediately."
  }, {
    icon: Calendar,
    title: "Instant Scheduling",
    body: "Book online or by phone any time. Our system confirms your appointment automatically and sends reminders."
  }, {
    icon: CircleCheck,
    title: "Automated Follow-Up",
    body: "After every job, we follow up automatically to make sure you're satisfied — and make it easy to leave a review."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "ai", className: "py-24 bg-secondary/40 scroll-mt-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "Always On. Always Ready.", title: "You shouldn't wait on hold for an HVAC tech.", sub: "ABC HVAC uses AI to make sure every call is answered, every appointment is booked, and every emergency is routed — instantly, day or night." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 mb-16", children: features.map((f2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i2 * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 rounded-2xl bg-white hover:border-turquoise/40 border border-transparent hover:border transition", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(f2.icon, { className: "size-9 text-turquoise mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-charcoal mb-2", children: f2.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: f2.body })
      ] }) }, f2.title)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-3xl bg-gradient-to-br from-charcoal to-charcoal-soft p-1 shadow-luxe", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-charcoal rounded-[22px] p-8 md:p-12 grid md:grid-cols-2 gap-10 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-turquoise text-xs font-semibold tracking-[0.2em] uppercase mb-3", children: "Live Demo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-3xl md:text-4xl font-semibold text-white mb-4", children: "Try the Demo — See Our AI HVAC Assistant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 mb-6", children: "Sample: customer reports AC failure → AI qualifies urgency → books emergency slot → confirms via SMS within 60 seconds." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setDemoOpen(true), className: "bg-turquoise text-white font-semibold px-6 py-3.5 rounded-xl inline-flex items-center gap-2 hover:opacity-90 transition shadow-turquoise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "size-5" }),
            " Launch Interactive Demo"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-5 space-y-3 text-sm shadow-luxe", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DemoBubble, { who: "AI", children: "Hi, this is ABC HVAC. What's the issue today?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DemoBubble, { who: "You", children: "My AC stopped working and it's 95 degrees outside." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DemoBubble, { who: "AI", children: "That's an emergency — I'm dispatching a tech now. Can I confirm your address?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DemoBubble, { who: "You", children: "456 Oak Ave, Silver Spring." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DemoBubble, { who: "AI", children: "Technician James is en route — arrives within 45 minutes. SMS confirmation sent." })
        ] })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DemoModal, { open: demoOpen, onClose: () => setDemoOpen(false) })
  ] });
}
function DemoBubble({
  who,
  ...
  const isAI = who === "AI";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isAI ? "justify-start" : "justify-end"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[85%] px-4 py-2 rounded-2xl ${isAI ? "bg-secondary text-charcoal rounded-bl-sm" : "bg-turquoise text-white rounded-br-sm"}`, children }) });
}
function ServiceArea() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "area", className: "py-24 bg-white scroll-mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "DMV Service Area", title: "Proudly Serving the Entire DMV", sub: "From DC to Annapolis, Silver Spring to Alexandria — we're your local HVAC experts." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 max-w-4xl mx-auto", children: areas.map((a2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-secondary/60 border border-border hover:border-turquoise px-5 py-2.5 rounded-full text-sm font-medium text-charcoal flex items-center gap-2 transition hover:shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "size-4 text-turquoise" }),
      " ",
      a2
    ] }, a2)) }) })
  ] }) });
...
function FoundingBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-5 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-turquoise/10 border border-turquoise/30 p-8 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-turquoise text-white text-xs font-bold tracking-wider uppercase px-3 py-1.5 rounded-full mb-4", children: "● Founding Customer Spots Available — Limited" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-charcoal text-lg md:text-xl leading-relaxed max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "ABC HVAC is now serving the DMV" }),
      " — be one of our founding customers and receive priority scheduling and a free system inspection with your first service call."
    ] })
  ] }) }) }) });
}
function EmergencyBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-charcoal py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-5 lg:px-8 grid md:grid-cols-[1fr_auto] gap-8 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-semibold text-white mb-3", children: [
        "HVAC Emergency? ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-turquoise", children: "We're Ready Right Now." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-lg", children: "No AC in summer heat, no heat in winter — 24/7 dispatch across the DMV. Talk to our AI agent or call directly. We'll have a tech on the way." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => startVapi(VAPI_ASSISTANT_ID), className: "pulse-ring relative bg-turquoise text-white font-semibold px-6 py-3.5 rounded-xl inline-flex items-center justify-center gap-2 hover:opacity-90 transition", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-5" }),
        " Speak With Someone Now"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE}`, className: "bg-transparent border-2 border-white text-white font-semibold px-6 py-3.5 rounded-xl inline-flex items-center justify-center gap-2 hover:bg-white hover:text-charcoal transition", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-5" }),
        " Call ",
        PHONE
      ] })
...
function FinalCTA({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "book", className: "bg-charcoal py-24 relative overflow-hidden scroll-mt-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-turquoise/10 via-transparent to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-4xl mx-auto px-5 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-6xl font-semibold text-white mb-5 leading-tight", children: [
        "Your Comfort Won't Fix Itself. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-turquoise", children: "We Will." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-lg md:text-xl mb-10 max-w-2xl mx-auto", children: "Book your appointment now or talk to our AI assistant instantly — ABC HVAC is ready for your home, business, or facility across the entire DMV." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onBook, className: "bg-turquoise text-white font-semibold px-8 py-4 rounded-xl inline-flex items-center justify-center gap-2 hover:opacity-90 shadow-turquoise transition animate-float", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "size-5" }),
          " Book My Appointment"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => startVapi(VAPI_ASSISTANT_ID), className: "pulse-ring relative bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-xl inline-flex items-center justify-center gap-2 hover:bg-white hover:text-charcoal transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-5" }),
          " Speak With Someone Now"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/80 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${EMAIL}`, className: "hover:text-turquoise inline-flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-4" }),
          " ",
          EMAIL
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE}`, className: "hover:text-turquoise inline-flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4" }),
          " ",
          PHONE
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-sm mt-6", children: "Licensed. Insured. Available 24/7. Serving DC · Maryland · Virginia" })
    ] }) })
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-charcoal border-t border-white/10 text-white/80", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-5 lg:px-8 py-14 grid md:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-lg bg-turquoise flex items-center justify-center text-white font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AirVent, { className: "size-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-semibold text-white", children: "ABC HVAC" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "italic text-white/70", children: '"Comfort Done Right. Every Time."' })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-3 text-sm tracking-wider uppercase", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: ["Services", "Get Estimate", "Who We Serve", "Service Area", "Emergency Service", "Contact"].map((l2) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-turquoise transition", children: l2 }) }, l2)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-3 text-sm tracking-wider uppercase", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE}`, className: "text-sm flex items-center gap-2 mb-2 hover:text-turquoise transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4 text-turquoise" }),
          " ",
          PHONE
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${EMAIL}`, className: "text-sm flex items-center gap-2 hover:text-turquoise transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-4 text-turquoise" }),
          " ",
          EMAIL
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 mt-4", children: "Licensed & Insured · DC · MD · VA" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 py-5 text-center text-xs text-white/50", children: "© 2026 ABC HVAC. All rights reserved. Licensed & Insured. Serving the DMV." })
  ] });
}
export {
  Index as component
